...
<body>
  ...
  <div class="dashboard-container">
    ...
    <div class="content">
        ...
        <form method="POST" action="{{ route('crm.store_cash') }}" style="max-width:600px; margin:auto;">
          @csrf
          ...
          <div style="margin-bottom: 20px;">
            ...
            <div style="position: relative;">
              ...
              <select name="peruntukan" class="form-control" style="padding-left:40px; height:45px;">
                ...
                <option value="Zakat" {{ old('peruntukan') == 'Zakat' ? 'selected' : '' }}>Zakat</option>
                <option value="Infak" {{ old('peruntukan') == 'Infak' ? 'selected' : '' }}>Infak</option>
                <option value="Sedekah" {{ old('peruntukan') == 'Sedekah' ? 'selected' : '' }}>Sedekah</option>
                <option value="Program Khusus" {{ old('peruntukan') == 'Program Khusus' ? 'selected' : '' }}>Program Khusus</option>
