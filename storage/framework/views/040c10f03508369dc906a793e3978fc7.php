...
<body>
  ...
  <nav class="sidebar">
    ...
    <ul>
      ...
      <?php if(Auth::user()->role === 'Keuangan' || Auth::user()->role === 'keuangan'): ?>
      <li>
  ...
  <div class="dashboard-container">
    ...
    <div class="content">
      <h2>Dashboard <?php echo e(Auth::user()->role); ?></h2>
      <p>Selamat datang di dashboard Lembaga Philanthropy, <?php echo e(Auth::user()->name); ?>.</p>
      
      <!-- Informasi hak akses berdasarkan role -->
      <div class="permissions-info">
        <?php if(Auth::user()->role === 'crm'): ?>
...
</html><?php /**PATH C:\xampp\htdocs\donasiq-app\resources\views/dashboard.blade.php ENDPATH**/ ?>